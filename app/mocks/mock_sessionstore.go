...
func (m *MockSessionStore) CurrentUser(arg0 *http.Request) (*models.User, error) {
...
func (mr *MockSessionStoreMockRecorder) CurrentUser(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CurrentUser", reflect.TypeOf((*MockSessionStore)(nil).CurrentUser), arg0)
}

// IsLoggedIn mocks base method
func (m *MockSessionStore) IsLoggedIn(arg0 *http.Request) (bool, error) {
...
func (mr *MockSessionStoreMockRecorder) IsLoggedIn(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsLoggedIn", reflect.TypeOf((*MockSessionStore)(nil).IsLoggedIn), arg0)
}
...
func (m *MockSessionStore) Logout(arg0 http.ResponseWriter, arg1 *http.Request) error {
...
func (mr *MockSessionStoreMockRecorder) Logout(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Logout", reflect.TypeOf((*MockSessionStore)(nil).Logout), arg0, arg1)
}
